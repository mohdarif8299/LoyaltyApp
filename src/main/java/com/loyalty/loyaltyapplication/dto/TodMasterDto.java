...
public class TodMasterDto {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TodMasterDto)) return false;
        TodMasterDto that = (TodMasterDto) o;
        return Objects.equals(getId(), that.getId()) && Objects.equals(getMembershipNumber(), that.getMembershipNumber()) && Objects.equals(getParty_name(), that.getParty_name()) && Objects.equals(getTransaction_amt_till_date(), that.getTransaction_amt_till_date()) && Objects.equals(getCurrency_type(), that.getCurrency_type()) && Objects.equals(getTotal_tod_issued_till_date(), that.getTotal_tod_issued_till_date()) && Objects.equals(getAmount_paid_till_date(), that.getAmount_paid_till_date()) && Objects.equals(getTotal_tod_claimed_till_date(), that.getTotal_tod_claimed_till_date()) && Objects.equals(getBalance_points(), that.getBalance_points());
    }
